...
public class ManHinh extends javax.swing.JFrame {
    ...
    public ManHinh() {
        ...
        showDetailAt(tblKhachHang.getRowCount() - 1);
    }
    ...
    public void showDetailAt(int index) {
    ...
    public KhachHang getFormData() {
        if(txtMa.getText().isEmpty()
            ...
            JOptionPane.showMessageDialog(this, "Vui long nhap het thong tin");
            return null;
        }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        this.loadTable(khachHangRepository.search());
